...
export const repos: Record<string, string> = {
  ...
  haskell: 'https://unpkg.com/tree-sitter-haskell',
  hcl: 'https://unpkg.com/@tree-sitter-grammars/tree-sitter-hcl',
  ...
  lua: 'https://unpkg.com/@tree-sitter-grammars/tree-sitter-lua',
